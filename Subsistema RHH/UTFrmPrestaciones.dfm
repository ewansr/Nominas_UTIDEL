object FrmPrestaciones: TFrmPrestaciones
    ...
    object advfcpgPage_Aguinaldo: TAdvOfficePage
      ...
      object dbgrd3: TDBGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'CodigoDiasAguinaldo'
            Title.Caption = 'C'#243'digo Dias Aguinaldo'
            Width = 155
            Visible = True
          end
          item
      ...
      object advtbstDiasAguinaldo: TAdvTabSet
        ...
        TabOverlap = 0
        TabStyle = tsDotNet
        OnMouseUp = advtbstDiasAguinaldoMouseUp
      end
      object pnl_DatosLinea: TPanel
        ...
        object edtFechaAplicacion: TJvDatePickerEdit
          Left = 106
          Top = 8
          Width = 121
          Height = 21
        ...
        object dbEditCodDiasAguinaldo: TDBAdvEdit
          Left = 104
          Top = 62
          Width = 201
          Height = 21
          LabelCaption = 'Codigo Aguinaldo:'
          LabelFont.Charset = DEFAULT_CHARSET
          LabelFont.Color = clWindowText
          LabelFont.Height = -11
          LabelFont.Name = 'Tahoma'
  ...
  object cdAguinaldo: TClientDataSet
    Aggregates = <>
    Params = <>
    AfterOpen = cdAguinaldoAfterOpen
    AfterRefresh = cdAguinaldoAfterRefresh
    Left = 240
    Top = 240
  end
