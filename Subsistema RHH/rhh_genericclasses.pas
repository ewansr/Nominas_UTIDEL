        ...
        begin
          ...
          begin
            ...
            begin
              ...
              DesgloseImss := DesgloseImss + '\n Aplica sobre [SMGVDF] SalMinDF:' + Valores.Elemento('EMPLEADO.SalMinDF').AsString + ' * DíasTImss: ' + Valores.Elemento('EMPLEADO.DIASTIMSS').AsString + ' - Inasistencias: ' + Valores.Elemento('EMPLEADO.Inasistencias').AsString + ' = ' + FloatToStr(Aplicar);
            end;
