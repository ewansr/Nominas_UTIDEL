...
uses
  ...
  Dialogs, ExtCtrls, ExBar, URegistro, DBClient, ClientModuleUnit1, DB,
  frxClass, frxDBSet, StdCtrls, JvExControls, JvLabel, AdvGlowButton,
...
uses UInfoPanel, UInteliDialog, UTFrmNuevoSalario;

{$R *.dfm}

procedure TFrmCatalogoSalarios.NextDBGrid1CellDblClick(Sender: TObject; ACol,
  ARow: Integer);
var
  Marca: TBookMark;
begin
...
procedure TFrmCatalogoSalarios.NextDBGrid1CellFormating(Sender: TObject; ACol,
...
procedure TFrmCatalogoSalarios.cbGrupoSalarioChange(Sender: TObject);
begin
...
procedure TFrmCatalogoSalarios.cbOrganizacionChange(Sender: TObject);
begin
  cdOrganizacion.RecNo := cbOrganizacion.ItemIndex +1;
  cdSalarios.Close;
end;

procedure TFrmCatalogoSalarios.cbTiposNominaChange(Sender: TObject);
begin
...
procedure TFrmCatalogoSalarios.cdSalariosAfterClose(DataSet: TDataSet);
begin
  while MemorySalarios.RecordCount > 0 do
    MemorySalarios.Delete;
end;

procedure TFrmCatalogoSalarios.cdSalariosAfterOpen(DataSet: TDataSet);
begin
  CargarDatos;
end;

procedure TFrmCatalogoSalarios.cdSalariosAfterRefresh(DataSet: TDataSet);
begin
  CargarDatos;
end;
...
procedure TFrmCatalogoSalarios.Btn_BuscarClick(Sender: TObject);
var
  Cursor: TCursor;
begin
  ...
  Try
    ...
    Try
      ...
      begin
        ...
        if Not CargarDatosFiltrados(cdSalarios, 'IdOrganizacion,IdTipoNomina,IdGrupoSalario', [cdOrganizacion.FieldByName('IdOrganizacion').AsInteger, cdTipoNomina.FieldByName('IdTipoNomina').AsInteger, cdGrupoSalario.FieldByName('IdGrupoSalario').AsInteger]) then
...
procedure TFrmCatalogoSalarios.CargarDatos;
var
  FieldName: String;
  Integrado: Extended;
begin
...
function TFrmCatalogoSalarios.EditarRegistro: Boolean;
var
  Resultado: Boolean;
begin
  Resultado := False;
...
procedure TFrmCatalogoSalarios.Refrescar(DataSet: TClientDataSet);
var
  OldCursor: TCursor;
begin
...
procedure TFrmCatalogoSalarios.ItemClick(Sender: TObject; Id: Integer);
var
