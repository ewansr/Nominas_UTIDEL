object FrmConcentradoPTU: TFrmConcentradoPTU
  Left = 0
  Top = 0
  Caption = 'Concentrado de PTU'
  ClientHeight = 472
  ClientWidth = 996
  Color = clBtnFace
  ...
  object CxGridEmpleados: TcxGrid
    ...
    object CxGridDatosEmpleado: TcxGridDBTableView
      ...
      DataController.DataSource = dsPTU
      ...
      DataController.Summary.FooterSummaryItems = <
        ...
        item
          Kind = skSum
          FieldName = 'XDiasTrab'
          Column = CxColumnXDiasTrab
          Sorted = True
        end
        item
          Kind = skSum
          FieldName = 'XSSueldos'
          Column = CxColumnXSSueldos
        end
        item
          Kind = skSum
          FieldName = 'PTUEmpleado'
          Column = CxColumnTotalPTu
          Sorted = True
        end
        item
          Kind = skSum
          FieldName = 'PTUEmpleadoGrav'
          Column = CxColumnPTUGrav
          Sorted = True
        end
        item
          Kind = skSum
      ...
      object CxColumnMesInicial: TcxGridDBColumn
        Caption = 'Mes Inicial'
        DataBinding.FieldName = 'MesInicial'
        HeaderAlignmentHorz = taCenter
      end
      object CxColumnMesFinal: TcxGridDBColumn
        Caption = 'Mes Final'
        DataBinding.FieldName = 'MesFinal'
        HeaderAlignmentHorz = taCenter
      end
      ...
      object CxColumnFactorDias: TcxGridDBColumn
        Caption = 'Factor D'#237'as'
        DataBinding.FieldName = 'FactorDias'
        HeaderAlignmentHorz = taCenter
      end
      object CxColumnXDiasTrab: TcxGridDBColumn
        Caption = '50 % PTU Dias Trabajados'
        DataBinding.FieldName = 'XDiasTrab'
        HeaderAlignmentHorz = taCenter
      end
      object CxColumnFactorSalario: TcxGridDBColumn
        Caption = 'Factor Salario'
        DataBinding.FieldName = 'FactorSalario'
        HeaderAlignmentHorz = taCenter
      end
      object CxColumnXSSueldos: TcxGridDBColumn
        Caption = '50% PTU S/Sueldos'
        DataBinding.FieldName = 'XSSueldos'
        HeaderAlignmentHorz = taCenter
      end
      object CxColumnTotalPTu: TcxGridDBColumn
        Caption = 'Total PTU'
        DataBinding.FieldName = 'PTUEmpleado'
        HeaderAlignmentHorz = taCenter
      end
      object CxColumnPTUExcento: TcxGridDBColumn
        Caption = 'PTU Exento'
        DataBinding.FieldName = 'PTUEmpleadoExcento'
        HeaderAlignmentHorz = taCenter
      end
      object CxColumnPTUGrav: TcxGridDBColumn
        Caption = 'PTU Gravado'
        DataBinding.FieldName = 'PTUEmpleadoGrav'
        HeaderAlignmentHorz = taCenter
      end
      ...
      object CxColumnRetencionISR: TcxGridDBColumn
        Caption = 'Retencion'#13#10'ISR'
        DataBinding.FieldName = 'RetencionISR'
        HeaderAlignmentHorz = taCenter
      end
  ...
  object CxGridNominas: TcxGrid
    ...
    Align = alLeft
    TabOrder = 5
    object CxGridDNominas: TcxGridDBTableView
      Navigator.Buttons.CustomButtons = <>
      Navigator.Buttons.First.Visible = False
      Navigator.Buttons.PriorPage.Visible = False
      Navigator.Buttons.Prior.Visible = False
      ...
      Navigator.InfoPanel.Visible = True
      Navigator.Visible = True
      DataController.DataSource = dsNominas
      DataController.Filter.Active = True
      DataController.Filter.AutoDataSetFilter = True
      DataController.Summary.DefaultGroupSummaryItems = <>
      DataController.Summary.FooterSummaryItems = <>
      ...
      Styles.Content = cxstylFontContent
      Styles.Header = cxstylFont
      object CxColumnIdNomina: TcxGridDBColumn
        DataBinding.FieldName = 'IdNomina'
        Visible = False
      end
      object CxColumnNomina: TcxGridDBColumn
        Caption = 'N'#243'mina'
    ...
    object CxLevelDatosN: TcxGridLevel
      GridView = CxGridDNominas
    end
  end
  ...
  object CdPTU: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 272
    Top = 224
  end
  object dsPTU: TDataSource
    DataSet = CdPTU
    Left = 272
    Top = 168
  end
  ...
  object FrxReportRecibos: TfrxReport
    Version = '4.10.3'
    ...
    ReportOptions.CreateDate = 42010.522519062500000000
    ReportOptions.LastChange = 42019.679007951400000000
    ...
    ScriptText.Strings = (
      ...
      'begin'
        ...
        '  Memo10.Text := UPPERcASE(Memo10.Text);                        ' +
        '                                                                ' +
        '                                      '
      'end;'
      ''
      ...
      ''
      'end.')
    OnGetValue = FrxReportRecibosGetValue
    OnReportPrint = 'no '
    Left = 528
    Top = 248
    Datasets = <
      ...
      item
        DataSet = FrxCdDatosPTU
        DataSetName = 'FrxCdDatosPTU'
      end>
    Variables = <>
    Style = <>
    ...
    object Page1: TfrxReportPage
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Condition = 'FrxCdDatosPTU."IdPersonal"'
        object Memo9: TfrxMemoView
          Top = 1.000000000000000000
          Width = 627.401613860000000000
          Height = 861.732840000000000000
          ShowHint = False
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
        ...
        object Memo2: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'R E P A R T O   D E   U T I L I D A D E S')
          ParentFont = False
        end
        ...
        object Memo10: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[FrxCdDatosEmpresa."valor2"]  [FrxCdDatosEmpresa."valor3"]  [Frx' +
              'CdDatosEmpresa."valor4"]  [FrxCdDatosEmpresa."valor5"]')
          ParentFont = False
        end
        object Memo16: TfrxMemoView
          Top = 60.472440944881910000
        ...
        object Memo12: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'RECIBO POR CONCEPTO DE PAGO DE REPARTO DE UTILIDADES CORRESPONDI' +
              'ENTES AL EJERCICIO FISCAL DEL [FrxCdDatosPTU."PeriodoLaborado"]')
          ParentFont = False
        end
        object Memo13: TfrxMemoView
          Left = 3.779530000000000000
          Top = 452.850650000000000000
          ...
          Memo.UTF8W = (
              ...
              'Recib'#237' la cantidad arriba se'#241'alada como pago de Reparto de Utili' +
              'dades y hago constar que lo anterior es correcto y que no se me ' +
              'adeuda ninguna cantidad por estos ni por otros conceptos.')
          ParentFont = False
        end
        object Memo14: TfrxMemoView
          Left = 3.779530000000000000
          Top = 354.378169999999900000
          Width = 619.842920000000000000
          Height = 18.897650000000000000
          ShowHint = False
          Font.Charset = DEFAULT_CHARSET
        ...
        object FrxCdDatosPTUNombreCompleto: TfrxMemoView
          Left = 3.779530000000000000
          Top = 147.283550000000000000
          Width = 619.842920000000000000
          Height = 18.897650000000000000
          ShowHint = False
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[FrxCdDatosPTU."NombreCompleto"]')
          ParentFont = False
        end
        object FrxCdDatosPTUPeriodoLaborado: TfrxMemoView
          Left = 3.779530000000000000
          Top = 219.212740000000000000
          Width = 619.842920000000000000
          Height = 18.897650000000000000
          ShowHint = False
          DataField = 'PeriodoLaborado'
          DataSet = FrxCdDatosPTU
          DataSetName = 'FrxCdDatosPTU'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[FrxCdDatosPTU."PeriodoLaborado"]')
          ParentFont = False
        end
        object FrxCdDatosPTUNeto: TfrxMemoView
        ...
        object Line3: TfrxLineView
          Left = 519.031850000000000000
          Top = 166.181200000000000000
          Width = -400.630180000000000000
          ShowHint = False
          Frame.Width = 2.000000000000000000
          Diagonal = True
        end
        object FrxCdDatosPTUFechaPagoNomina: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[FrxCdDatosPTU."FechaPagoNomina"]')
          ParentFont = False
        end
        object FrxCdDatosPTURegistroPatronal: TfrxMemoView
          Left = 445.984540000000000000
          Top = 60.472440944881910000
          Width = 177.637910000000000000
          Height = 18.897650000000000000
          ShowHint = False
          DataField = 'RegistroPatronal'
          DataSet = FrxCdDatosPTU
          DataSetName = 'FrxCdDatosPTU'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[FrxCdDatosPTU."RegistroPatronal"]')
          ParentFont = False
        end
      end
  ...
  object FrxCdDatosPTU: TfrxDBDataset
    UserName = 'FrxCdDatosPTU'
    CloseDataSource = False
    FieldAliases.Strings = (
      'IdPersonal=IdPersonal'
      'NombreCompleto=NombreCompleto'
      'FechaPagoNomina=FechaPagoNomina'
      'PeriodoLaborado=PeriodoLaborado'
      'Neto=Neto'
