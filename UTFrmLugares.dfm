inherited FrmLugares: TFrmLugares
  Caption = 'Lugares'
  ClientWidth = 815
  ExplicitTop = -104
  ExplicitWidth = 823
  ...
  inherited PanelFiltro: TPanel
    ...
    inherited GroupBoxFiltro: TGroupBox
      ...
      object EditFCodigo: TEdit
        ...
        TabOrder = 0
        Text = 'C'#243'digo'
        OnEnter = EditFCodigoEnter
        OnExit = EditFCodigoExit
        OnKeyPress = EditFCodigoKeyPress
      end
      object EditFTitulo: TEdit
        Left = 168
        Top = 17
        Width = 121
        Height = 21
        TabOrder = 1
        Text = 'T'#237'tulo'
        OnEnter = EditFTituloEnter
        OnExit = EditFTituloExit
        OnKeyPress = EditFTituloKeyPress
      end
    end
  end
  ...
  object FrxLugares: TfrxDBDataset
    UserName = 'ReporteLugares'
  ...
  object frxReporteLugares: TfrxReport
    Version = '4.10.3'
    ...
    ReportOptions.LastChange = 40962.796058472220000000
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo2: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[ReporteLugares."codigolugar"]')
          ParentFont = False
        end
        object Memo3: TfrxMemoView
          Left = 106.370130000000000000
        ...
        object Memo4: TfrxMemoView
          ...
          Frame.Typ = [ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[ReporteLugares."ubicacion"]')
          ParentFont = False
        end
        object Memo5: TfrxMemoView
          Left = 354.819110000000000000
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 740.409927000000000000
        Condition = 'ReporteLugares."idlugar"'
      end
