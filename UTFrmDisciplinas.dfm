inherited FrmDisciplinas: TFrmDisciplinas
  Caption = 'Area'
  ClientWidth = 728
  ExplicitWidth = 744
  ExplicitHeight = 517
  ...
  object FrxDisciplinas: TfrxDBDataset
    UserName = 'ReporteDisciplinas'
    CloseDataSource = False
    DataSource = dsDatos
    BCDToCurrency = False
    Left = 480
  end
  object frxReporteDisciplinas: TfrxReport
    Version = '4.10.3'
    ...
    ReportOptions.LastChange = 40962.800273599540000000
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo2: TfrxMemoView
          ...
          Memo.UTF8W = (
            '[ReporteDisciplinas."codigodisciplina"]')
          ParentFont = False
        end
        object Memo3: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[ReporteDisciplinas."titulodisciplina"]')
          ParentFont = False
        end
        object Memo5: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[ReporteDisciplinas."descripcion"]')
          ParentFont = False
        end
        object Memo10: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[ReporteDisciplinas."comentarios"]')
          ParentFont = False
        end
      end
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 740.409927000000000000
        Condition = 'ReporteDisciplinas."iddisciplina"'
      end
