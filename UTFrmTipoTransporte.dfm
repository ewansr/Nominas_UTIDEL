inherited FrmTipoTransporte: TFrmTipoTransporte
  Caption = 'Tipos de transportes'
  ExplicitTop = -134
  ExplicitWidth = 852
  ExplicitHeight = 506
  PixelsPerInch = 96
  ...
  inherited PanelFiltro: TPanel
    inherited GroupBoxFiltro: TGroupBox
      ...
      object editFcodigos: TAdvEdit
        ...
        TabOrder = 0
        Visible = True
        OnKeyPress = editFcodigosKeyPress
        Version = '2.9.0.0'
      end
      object editFTitulos: TAdvEdit
        Left = 151
        Top = 17
        Width = 120
        Height = 21
  ...
  inherited PanelPrincipal: TPanel
    inherited DBGridPrincipal: TNextDBGrid
      object NxDBTextColumn1: TNxDBTextColumn
        ...
        Width = 140
        FieldName = 'codigotipotransporte'
      end
  ...
  object frxReporteTipoTransportes: TfrxReport
    Version = '4.10.3'
    ...
    ReportOptions.LastChange = 40962.813381064810000000
    ...
    Datasets = <
      ...
      item
        DataSet = FrxTipoTransportes
        DataSetName = 'ReporteTipoTransportes'
      end>
    Variables = <>
    Style = <>
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo2: TfrxMemoView
          ...
          Memo.UTF8W = (
            '[Reportetipotransportes."codigotipotransporte"]')
          ParentFont = False
        end
        object Memo3: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[Reportetipotransportes."titulotipotransporte"]')
          ParentFont = False
        end
        object Memo5: TfrxMemoView
          ...
          Memo.UTF8W = (
            '[Reportetipotransportes."descripcion"]')
          ParentFont = False
        end
        object Memo10: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[Reportetipotransportes."comentarios"]')
          ParentFont = False
        end
      end
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 740.409927000000000000
        Condition = 'ReporteTipoTransportes."idtipotransporte"'
      end
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo1: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            'Cat'#225'logo de tipos de transportes')
          ParentFont = False
        end
  ...
  object FrxTipoTransportes: TfrxDBDataset
    UserName = 'ReporteTipoTransportes'
