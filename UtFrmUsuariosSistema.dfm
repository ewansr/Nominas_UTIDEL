object FrmUsuariosSistema: TFrmUsuariosSistema
  Left = 0
  Top = 0
  ...
  object cxGrid1: TcxGrid
    ...
    object CxGridUsuarios: TcxGridDBTableView
      ...
      OnCellDblClick = CxGridUsuariosCellDblClick
      ...
      object CxColumnsIdUsuario: TcxGridDBColumn
        Caption = 'Usuario'
      ...
      object CxColumnMail: TcxGridDBColumn
        Caption = 'e-Mail'
        DataBinding.FieldName = 'sMail'
        Width = 165
      end
      object CxColumnsPuesto: TcxGridDBColumn
        Caption = 'Puesto'
        DataBinding.FieldName = 'sPuesto'
        Width = 190
      end
      object CxColumnGrupo: TcxGridDBColumn
        Caption = 'Grupo'
  ...
  object cxGBDatos: TcxGroupBox
    ...
    Height = 441
    Width = 441
    object CxDbTxtUsuario: TcxDBTextEdit
      Left = 80
      Top = 24
      DataBinding.DataField = 'sIdUsuario'
      DataBinding.DataSource = dsUsuarioupt
      TabOrder = 0
      Width = 353
    end
    object CxDbTxtPassword: TcxDBTextEdit
      Left = 80
      Top = 48
    ...
    object cxGBProcesos: TcxGroupBox
      Left = 10
      Top = 96
      Caption = 'Permisos'
      Enabled = False
      ...
      object CxVGrid1: TcxDBVerticalGrid
        ...
        Navigator.Buttons.CustomButtons = <>
        TabOrder = 0
        DataController.DataSource = dsUsuarioupt
        Version = 1
        object CxCategoryEstimaciones: TcxCategoryRow
          Properties.Caption = 'Estimaciones Generales'
          ID = 0
          ParentID = -1
          Index = 0
          Version = 1
        end
        object CxEditorAutorizar: TcxDBEditorRow
          Properties.Caption = 'Autorizar'
          Properties.EditPropertiesClassName = 'TcxComboBoxProperties'
          Properties.EditProperties.Items.Strings = (
            'Si'
            'No')
          Properties.DataBinding.FieldName = 'lAutorizaEstimacion'
          ID = 1
          ParentID = -1
          Index = 1
          Version = 1
        end
        object CxEditorValidar: TcxDBEditorRow
          Properties.Caption = 'Validar'
          Properties.EditPropertiesClassName = 'TcxComboBoxProperties'
          Properties.EditProperties.Items.Strings = (
            'Si'
            'No')
          Properties.DataBinding.FieldName = 'LValidaEstimacion'
          ID = 2
          ParentID = -1
          Index = 2
          Version = 1
        end
        object CxEditorDesautorizar: TcxDBEditorRow
          Properties.Caption = 'Desautorizar'
          Properties.EditPropertiesClassName = 'TcxComboBoxProperties'
          Properties.EditProperties.Items.Strings = (
            'Si'
            'No')
          Properties.DataBinding.FieldName = 'lDesautorizaEstimacion'
          ID = 3
          ParentID = -1
          Index = 3
          Version = 1
        end
        object CxEditorDesvalidar: TcxDBEditorRow
          Properties.Caption = 'Desvalidar'
          Properties.EditPropertiesClassName = 'TcxComboBoxProperties'
          Properties.EditProperties.Items.Strings = (
            'Si'
            'No')
          Properties.DataBinding.FieldName = 'lDesvalidaEstimacion'
          ID = 4
          ParentID = -1
          Index = 4
          Version = 1
        end
        object CxCategoryRequisiciones: TcxCategoryRow
          Properties.Caption = 'Requisiciones'
          ID = 5
          ParentID = -1
          Index = 5
          Version = 1
        end
        object CxEditorRecibeReq: TcxDBEditorRow
          Properties.Caption = 'Recibe Requisiciones'
          Properties.EditPropertiesClassName = 'TcxComboBoxProperties'
          Properties.EditProperties.Items.Strings = (
            'Si'
            'No')
          Properties.DataBinding.FieldName = 'lRecibeReq'
          ID = 6
          ParentID = -1
          Index = 6
          Version = 1
        end
        object CxEditorVerificaReq: TcxDBEditorRow
          Properties.Caption = 'Verifica Requisiciones'
          Properties.EditPropertiesClassName = 'TcxComboBoxProperties'
          Properties.EditProperties.Items.Strings = (
            'Si'
            'No')
          Properties.DataBinding.FieldName = 'lVerificaReq'
          ID = 7
          ParentID = -1
          Index = 7
          Version = 1
        end
        object CxEditorAutorizaReq: TcxDBEditorRow
          Properties.Caption = 'Autoriza Requisiciones'
          Properties.EditPropertiesClassName = 'TcxComboBoxProperties'
          Properties.EditProperties.Items.Strings = (
            'Si'
            'No')
          Properties.DataBinding.FieldName = 'lAutorizaRequisiciones'
          ID = 8
          ParentID = -1
          Index = 8
          Version = 1
        end
        object CxCategoryOrdenesTrabajo: TcxCategoryRow
          Properties.Caption = 'Ordenes de Compra'
          ID = 9
          ParentID = -1
          Index = 9
          Version = 1
        end
        object CxEditorCompraOp: TcxDBEditorRow
          Properties.Caption = 'Revisa O.C. Operaciones'
          Properties.EditPropertiesClassName = 'TcxComboBoxProperties'
          Properties.EditProperties.Items.Strings = (
            'Si'
            'No')
          Properties.DataBinding.FieldName = 'llRevisaGOperacion'
          ID = 10
          ParentID = -1
          Index = 10
          Version = 1
        end
        object CxEditorCompraAdmon: TcxDBEditorRow
          Properties.Caption = 'Revisa O.C. Adm'#243'n'
          Properties.EditPropertiesClassName = 'TcxComboBoxProperties'
          Properties.EditProperties.Items.Strings = (
            'Si'
            'No')
          Properties.DataBinding.FieldName = 'lRevisaCoordAdmin'
          ID = 11
          ParentID = -1
          Index = 11
          Version = 1
        end
        object CxEditorAutorizaOC: TcxDBEditorRow
          Properties.Caption = 'Autoriza O.C.'
          Properties.EditPropertiesClassName = 'TcxComboBoxProperties'
          Properties.EditProperties.Items.Strings = (
            'Si'
            'No')
          Properties.DataBinding.FieldName = 'lAutorizaPedido'
          ID = 12
          ParentID = -1
          Index = 12
          Version = 1
        end
        object CxCategoryValidaProcesos: TcxCategoryRow
        ...
        object CxEditorAutorizaProc: TcxDBEditorRow
          Properties.Caption = 'Autoriza Procesos'
          Properties.EditPropertiesClassName = 'TcxComboBoxProperties'
          Properties.EditProperties.Items.Strings = (
            'Si'
            'No')
          Properties.DataBinding.FieldName = 'lAutoriza'
          ID = 14
          ParentID = -1
          Index = 14
          Version = 1
        end
        object CxEditorValidaProc: TcxDBEditorRow
          Properties.Caption = 'Valida Procesos'
          Properties.EditPropertiesClassName = 'TcxComboBoxProperties'
          Properties.EditProperties.Items.Strings = (
            'Si'
            'No')
          Properties.DataBinding.FieldName = 'lValida'
          ID = 15
          ParentID = -1
          Index = 15
          Version = 1
        end
        object CxEditorDesRepDiario: TcxDBEditorRow
          Properties.Caption = 'Desautoriza Rep. Diario'
          Properties.EditPropertiesClassName = 'TcxComboBoxProperties'
          Properties.EditProperties.Items.Strings = (
            'Si'
            'No')
          Properties.DataBinding.FieldName = 'lDesAutorizaRD'
          ID = 16
          ParentID = -1
          Index = 16
          Version = 1
        end
        object CxEditorDesvRepDiario: TcxDBEditorRow
          Properties.Caption = 'Desvalida Rep. Diario'
          Properties.EditPropertiesClassName = 'TcxComboBoxProperties'
          Properties.EditProperties.Items.Strings = (
            'Si'
            'No')
          Properties.DataBinding.FieldName = 'lDesValidaRD'
          ID = 17
          ParentID = -1
          Index = 17
          Version = 1
        end
        object CxEditorDesAutorizagenerador: TcxDBEditorRow
          Properties.Caption = 'Desautoriza Generador'
          Properties.EditPropertiesClassName = 'TcxComboBoxProperties'
          Properties.EditProperties.Items.Strings = (
            'Si'
            'No')
          Properties.DataBinding.FieldName = 'lDesAutorizaGeneradores'
          ID = 18
          ParentID = -1
          Index = 18
          Version = 1
        end
        object CxEditorDesvalidaGenerador: TcxDBEditorRow
          Properties.Caption = 'Desvalida Generador'
          Properties.EditPropertiesClassName = 'TcxComboBoxProperties'
          Properties.EditProperties.Items.Strings = (
            'Si'
            'No')
          Properties.DataBinding.FieldName = 'lDesValidaGeneradores'
          ID = 19
          ParentID = -1
          Index = 19
          Version = 1
        end
        object CxCategoryOtros: TcxCategoryRow
          Properties.Caption = 'Otros'
          ID = 20
          ParentID = -1
          Index = 20
          Version = 1
        end
        object CxEditorAsignaFC: TcxDBEditorRow
          Properties.Caption = 'Asigna Frente y Contrato'
          Properties.EditPropertiesClassName = 'TcxComboBoxProperties'
          Properties.EditProperties.Items.Strings = (
            'Si'
            'No')
          Properties.DataBinding.FieldName = 'lAsignaFrentes'
          ID = 21
          ParentID = -1
          Index = 21
          Version = 1
        end
        object CxEditorRevisaBarco: TcxDBEditorRow
          Properties.Caption = 'Revisa Barco'
          Properties.EditPropertiesClassName = 'TcxComboBoxProperties'
          Properties.EditProperties.Items.Strings = (
            'Si'
            'No')
          Properties.DataBinding.FieldName = 'lRevisaBarco'
          ID = 22
          ParentID = -1
          Index = 22
          Version = 1
        end
        object CxEditorAjusteAv: TcxDBEditorRow
          Properties.Caption = 'Realiza Ajuste Av.'
          Properties.EditPropertiesClassName = 'TcxComboBoxProperties'
          Properties.EditProperties.Items.Strings = (
            'Si'
            'No')
          Properties.DataBinding.FieldName = 'lRealizaAjustes'
          ID = 23
          ParentID = -1
          Index = 23
          Version = 1
    ...
    object CxLblPass: TcxLabel
      Left = 10
      Top = 49
      Caption = 'Contrase'#241'a:'
      Transparent = True
    end
    object CxLblNombre: TcxLabel
      Left = 10
      Top = 72
      Caption = 'Nombre:'
      Transparent = True
    ...
    object CxLookUpRoles: TcxDBExtLookupComboBox
      Left = 111
      Top = -3
      DataBinding.DataField = 'idRol'
      DataBinding.DataSource = dsUsuarioupt
      Properties.View = CxGridRoles
      Properties.KeyFieldNames = 'idRol'
      Properties.ListFieldItem = CxColumnTitulo
      TabOrder = 3
      Visible = False
      Width = 298
    end
    object CxLblRoles: TcxLabel
      Left = 195
      Top = 1
      Caption = 'Roles:'
      Transparent = True
  ...
  object dsUsuarioupt: TDataSource
    DataSet = CdUsuarioUpt
    Left = 672
  end
  object CxGridReposRoles: TcxGridViewRepository
    Left = 568
    Top = 200
    object CxGridRoles: TcxGridDBTableView
      Navigator.Buttons.CustomButtons = <>
      DataController.DataSource = dsRoles
      DataController.KeyFieldNames = 'idRol'
      DataController.Summary.DefaultGroupSummaryItems = <>
      DataController.Summary.FooterSummaryItems = <>
      DataController.Summary.SummaryGroups = <>
      object CxColumnIdRol: TcxGridDBColumn
        DataBinding.FieldName = 'IdRol'
      end
      object CxColumnTitulo: TcxGridDBColumn
        DataBinding.FieldName = 'TituloRol'
      end
    end
  end
  object CdRoles: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 448
    Top = 264
  ...
  object frxReporteUsuarios: TfrxReport
    ...
    ReportOptions.LastChange = 42114.929932430550000000
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        RowCount = 0
        Stretched = True
        object ReporteUsuariossIdUsuario: TfrxMemoView
          Left = 11.338590000000000000
          Width = 109.606370000000000000
          Height = 18.897650000000000000
          ShowHint = False
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[ReporteUsuarios."sIdUsuario"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object ReporteUsuariossNombre: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[ReporteUsuarios."sNombre"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object ReporteUsuariossMail: TfrxMemoView
          Left = 291.023810000000000000
          Width = 170.078850000000000000
          Height = 18.897650000000000000
          ShowHint = False
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[ReporteUsuarios."sMail"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object ReporteUsuariossPuesto: TfrxMemoView
          Left = 461.102660000000000000
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[ReporteUsuarios."sPuesto"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object ReporteUsuariossIdGrupo: TfrxMemoView
          Left = 600.945270000000000000
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 740.409927000000000000
        Condition = '<ReporteUsuarios."sIdUsuario">'
        Stretched = True
      end
    end
  end
  object frxUsuarios: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      ...
      'lAutorizaPedido=lAutorizaPedido'
      'sNombre=sNombre'
      'sMail=sMail'
