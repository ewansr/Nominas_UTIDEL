unit UTfrmReporteCotizacionSinEntrada;
...
type
  TFrmReporteCotSinEnt = class(TForm)
...
var
  FrmReporteCotSinEnt: TFrmReporteCotSinEnt;
...
procedure TFrmReporteCotSinEnt.AdvGlowButton1Click(Sender: TObject);
Var
...
begin
  try
    ...
    CrearConjunto(cdDatos,'rep_cotizacionmaterialsinentrada',ccSelect);
    ...
    CrearConjunto(cdDetalle,'rep_cotizacionmaterialsinentradadetalle',ccSelect);
    ...
    //Asignar archivo
    frxReporte.LoadFromFile(ExtractFilePath(Application.ExeName)+'\Reportes\'+'CotizacionMaterialesSinEntrada.fr3');
...
procedure TFrmReporteCotSinEnt.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Globales.SetValue('OrgPredeterminada',CmbConvenio.KeyValue);
end;

procedure TFrmReporteCotSinEnt.FormShow(Sender: TObject);
Var
  Hoy: TDate;
begin
...
procedure TFrmReporteCotSinEnt.EstableceIndex(Data:TclientDataset;Combo:TDBLookupComboBox);
begin
  try
...
procedure TFrmReporteCotSinEnt.CargarConvenios(Refrescar: Boolean);
var
  i: integer;
begin
