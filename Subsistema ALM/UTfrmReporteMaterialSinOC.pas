unit UTfrmReporteMaterialSinOC;
...
type
  TFrmReporteMatSinOC = class(TForm)
...
var
  FrmReporteMatSinOC: TFrmReporteMatSinOC;
...
procedure TFrmReporteMatSinOC.AdvGlowButton1Click(Sender: TObject);
Var
...
begin
  try
    ...
    CrearConjunto(cdDatos,'rep_solicitudmaterialsinoc',ccSelect);
    ...
    CrearConjunto(cdDetalle,'rep_solicitudmaterialsinocdetalle',ccSelect);
...
procedure TFrmReporteMatSinOC.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Globales.SetValue('OrgPredeterminada',CmbConvenio.KeyValue);
end;

procedure TFrmReporteMatSinOC.FormShow(Sender: TObject);
Var
  Hoy: TDate;
begin
...
procedure TFrmReporteMatSinOC.FiltroCombo;
begin

end;

procedure TFrmReporteMatSinOC.EstableceIndex(Data:TclientDataset;Combo:TDBLookupComboBox);
begin
  try
...
procedure TFrmReporteMatSinOC.CargarConvenios(Refrescar: Boolean);
var
  i: integer;
begin
