object FrmAsignarProveedor: TFrmAsignarProveedor
  Left = 0
  Top = 0
  Caption = 'Asignar requisici'#243'n a proveedores'
  ClientHeight = 636
  ClientWidth = 805
  Color = clBtnFace
  ...
  object pnlGeneral: TPanel
    ...
    object grdDetalle: TNextDBGrid
      Left = 22
      Top = 115
      Width = 763
      Height = 157
      Anchors = [akLeft, akTop, akRight, akBottom]
      PopupMenu = popCompradores
      TabOrder = 1
      TabStop = True
      OnMouseDown = grdDetalleMouseDown
      OnSortColumn = grdDetalleSortColumn
      OnVerticalScroll = grdDetalleVerticalScroll
    ...
    object grpComentario: TGroupBox
      Left = 22
      Top = 47
      Width = 763
      Height = 58
      Caption = 'Comentarios'
      TabOrder = 0
      object lblComentarios: TJvLabel
        Left = 10
        Top = 20
        Width = 732
        Height = 32
        AutoSize = False
        Caption = 'lblComentarios'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlue
        Font.Height = -11
        Font.Name = 'Tahoma'
    ...
    object pnlInfo: TAdvSmoothPanel
      ...
      Caption.ColorEnd = 47545
      Caption.LineColor = clYellow
      Fill.Color = 1645055
      Fill.ColorTo = clRed
      Fill.ColorMirror = clRed
      Fill.ColorMirrorTo = 1645055
      Fill.GradientMirrorType = gtVertical
      Fill.HatchStyle = HatchStyleDashedHorizontal
      Fill.HatchStyleMirror = HatchStyleForwardDiagonal
      Fill.BorderColor = clRed
      Fill.Rounding = 10
      Fill.ShadowColor = 13209
      ...
      object AdvSmoothLabel1: TAdvSmoothLabel
        ...
        Fill.ShadowOffset = 0
        Fill.Glow = gmNone
        Caption.Text = 'No existen partidas disponibles para el usuario actual'
        Caption.Font.Charset = DEFAULT_CHARSET
  ...
  object pnlDetalle: TPanel
    ...
    object Pagina1: TPanel
      ...
      object JvLabel2: TJvLabel
        ...
        Height = 13
        AutoSize = False
        Caption = 'Asignar los proveedores para solicitar cotizaciones'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlue
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object btnBuscaProv: TButton
        ...
        Caption = '...'
        TabOrder = 1
        OnClick = btnBuscaProvClick
      end
      object btnQuitarProv: TButton
        Left = 92
        Top = 81
        Width = 65
        Height = 25
      ...
      object edtCodigoProv: TEdit
        Left = 21
        Top = 28
        Width = 97
        Height = 21
        TabOrder = 0
        OnKeyPress = edtCodigoProvKeyPress
      end
      object grdProveedores: TNextDBGrid
        Left = 21
        Top = 112
        Width = 620
        Height = 113
        GridLinesColor = clBlack
        TabOrder = 4
        TabStop = True
        DataSource = dsProveedores
        OnCellFormating = grdProveedoresCellFormating
    ...
    object Pagina2: TPanel
      ...
      object JvLabel1: TJvLabel
        ...
        Height = 13
        AutoSize = False
        Caption = 'Indicar art'#237'culos por proveedor:'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlue
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object grdProveedores2: TNextDBGrid
        Left = 15
        Top = 48
        Width = 338
        Height = 177
        ...
        TabOrder = 0
        TabStop = True
        OnMouseDown = grdProveedores2MouseDown
        OnSortColumn = grdProveedores2SortColumn
        OnVerticalScroll = grdProveedores2VerticalScroll
        DataSource = dsProveedores
        OnCellFormating = grdProveedoresCellFormating
      ...
      object grdCotizacion: TNextDBGrid
        Left = 382
        Top = 51
        Width = 402
        Height = 173
        ...
        TabOrder = 1
        TabStop = True
        OnMouseDown = grdCotizacionMouseDown
        OnSortColumn = grdCotizacionSortColumn
        OnVerticalScroll = grdCotizacionVerticalScroll
        DataSource = dsCotizacionGrid
  ...
  object cdCompradores: TClientDataSet
    Aggregates = <>
    Params = <>
    RemoteServer = ClientModule1.DSProviderConnection1
    Left = 680
  ...
  object popCompradores: TPopupMenu
  ...
  object mdProveedores: TJvMemoryData
    Active = True
    FieldDefs = <
      item
        Name = 'idProveedor'
    ...
    BeforeScroll = mdProveedoresBeforeScroll
    AfterScroll = mdProveedoresAfterScroll
    Left = 480
    Top = 144
  end
  object dsProveedores: TJvDataSource
    DataSet = mdProveedores
    Left = 536
    Top = 144
  end
  object mdCotizacion: TJvMemoryData
    Active = True
    FieldDefs = <
      item
        Name = 'idcotizacion'
  ...
  object mdCotizacionGrid: TJvMemoryData
    Active = True
    FieldDefs = <
      item
        Name = 'idproveedor'
  ...
  object dsCotizacionGrid: TDataSource
    DataSet = mdCotizacionGrid
    Left = 600
    Top = 200
  end
  object dsproveee: TDataSource
    AutoEdit = False
    DataSet = mdProveedores
    Left = 600
    Top = 328
