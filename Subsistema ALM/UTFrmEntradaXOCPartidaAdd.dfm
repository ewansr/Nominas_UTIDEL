object FrmEntradaXOCPartidaAdd: TFrmEntradaXOCPartidaAdd
  Left = 0
  Top = 0
  ...
  object pnl2: TPanel
    ...
    object grd1: TNextDBGrid
      ...
      SelectionColor = 14347226
      TabOrder = 0
      TabStop = True
      OnCellClick = grd1CellClick
      OnEditAccept = grd1EditAccept
      OnMouseDown = grd1MouseDown
      OnVerticalScroll = grd1VerticalScroll
      DataSource = dsOCDetalle2
      OnCellFormating = grd1CellFormating
      object nxdbchckbxclmn1: TNxDBCheckBoxColumn
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'Tahoma'
        Font.Style = []
        Header.Caption = 'Agregar'
  ...
  object pnl3: TPanel
    ...
    Align = alBottom
    TabOrder = 2
    object btnBtnRec: TAdvShapeButton
      Left = 0
      Top = 4
      Width = 55
      Height = 46
  ...
  object mdOCDetalle2: TJvMemoryData
    FieldDefs = <>
    Left = 584
    Top = 208
  end
  object dsOCDetalle2: TDataSource
    DataSet = mdOCDetalle2
    Left = 648
    Top = 208
  end
