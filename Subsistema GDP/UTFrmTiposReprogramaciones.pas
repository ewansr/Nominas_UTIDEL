unit UTFrmTiposReprogramaciones;
...
uses
  ...
  AdvEdit, NxDBColumns, NxColumns, Spin, AdvProgressBar;
...
procedure TFrmTiposReprogramaciones.BtnSearchClick(Sender: TObject);
begin
  inherited;
  Filtrar;
end;
...
begin
  result := TFrmDatosTiposReprogramaciones.Create(Self);
end;
