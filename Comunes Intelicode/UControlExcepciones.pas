...
const
  TipoError: array[0..29, 0..1] of string = (('EAbort', 'Error catastrófico'),                                                      {: Finaliza la secuencia de eventos sin mostrar el mensaje de error.}
                                             ...
                                             ('InteligentException', 'Excepcioón de Inteli-Code'),                                  {: Excepcion generica propia de nuestros sistemas }
                                             ('InteligentWarning', 'Aviso de Inteli-Code'),                                         {: Mensajes de aviso propios de nuestrros sistemas }
                                             ('InteligentAbort', ' Error catastrófico'));                                           {: Erro catastrófico de Inteligent }
      ...
      begin
        ...
        if IdxError = -1 then
          case Indice of
            ...
            27: TipoMensaje := mtInformation;
            28: TipoMensaje := mtWarning;
            29: TipoMensaje := mtError;
          end;
...
begin
  AsignarSentencia(TZReadOnlyQuery(DataSet), NombreSentencia, TipoSentencia);
end;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        DataSet.ParamByName(Cadena).AsInteger := -1;
      end;
